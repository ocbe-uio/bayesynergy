...
#' 
#' @description 
#' The function \code{gibbs_BayeSyneRgy} is the main function of the BayeSyneRgy package. It will fit a Bayesian semi-parametric model for in-vitro drug combination experiments to estimate synergistic and antagonistic effects. 
#' 
...
gibbs_BayeSyneRgy <- function(y_mat, x_mat, drug_names=NULL, experiment_ID = NULL, log10_conc = FALSE, lower_asymptote = T, type = 2, Alg_param = list(), Hyper_param = list(), GP_param = list(), var_prior = 1, ...){
  ...
  class(BayeSyn_Out) <- "gibbs_BayeSyneRgy"
  return(BayeSyn_Out)
}
